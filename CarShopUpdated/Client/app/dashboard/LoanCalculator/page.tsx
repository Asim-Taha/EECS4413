...
export default function LoanCalculatorPage() {
  const HARDCODED_TOKEN = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjY3ZGY5MGU2MDgwOTEwMzYwMGI0YWU5YiIsIm5hbWUiOiJiYXJyeWFsbGVuIiwiaWF0IjoxNzQzNDAzMzA2LCJleHAiOjE3NDM0ODk3MDZ9.P5r5XujhqrWdQtOr2dQuo-rVy70mpKZlegnA4srlWC0"; // 🔐 Replace with a real token for testing
    ...
    try {
      const res = await fetch('http://localhost:8080/api/loan/calculate', {
        ...
        headers: {
          ...
          Authorization: `Bearer ${HARDCODED_TOKEN}`, // ✅ Add token here
        },
        body: JSON.stringify({
