...
export default function LoanCalculatorPage() {
  const HARDCODED_TOKEN = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjY3ZGY5MGU2MDgwOTEwMzYwMGI0YWU5YiIsIm5hbWUiOiJiYXJyeWFsbGVuIiwiaWF0IjoxNzQzNDczNzU4LCJleHAiOjE3NDM1NjAxNTh9.N1f-zR5oCPhKB_8yOEQJ6YHPkzzNQzJZQEuPg3rdkR8"; // 🔐 Replace with a real token for testing
