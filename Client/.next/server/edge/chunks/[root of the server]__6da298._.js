(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["chunks/[root of the server]__6da298._.js", {
...
"[project]/app/auth/session.ts [middleware] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function createSession(token) {
    ...
    (await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$request$2f$cookies$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["cookies"])()).set(cookie.name, token, {
        ...cookie.options,
        expires
    });
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$client$2f$components$2f$redirect$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["redirect"])('/dashboard');
}
async function verifySession() {
    const token = (await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$request$2f$cookies$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["cookies"])()).get("session")?.value;
    try {
...
async function deleteSession() {
    (await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$request$2f$cookies$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["cookies"])()).delete(cookie.name);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$client$2f$components$2f$redirect$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["redirect"])('/login');
}
}}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$auth$2f$session$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/app/auth/session.ts [middleware] (ecmascript)");
...
async function middleware(request) {
    ...
    const session = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$auth$2f$session$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__["verifySession"])();
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__6da298._.js.map